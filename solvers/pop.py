...
class PopSolver(BaseSolver):
    ...
    def init_model(self) -> None:
        self.model: List[int] = [0 for _ in range(self.num_items + 1)]  # type: ignore
    ...
    def calculate_loss(self, batch):
        ...
        for _, urows in zip(batch['uindex'], batch['urows']):
            ...
            for iindex, _, _ in urows:
                self.model[iindex] = self.model[iindex] + 1
    ...
    def calculate_rankers(self, batch):
        ...
        scores = Tensor(self.model).repeat(batch_size, 1)
    ...
    # override
    def backup(self):
        copyfile('solvers/pop.py', f'{self.data_dir}/solver.py')
