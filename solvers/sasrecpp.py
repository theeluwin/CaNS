...
class SASRecPPSolver(BaseLWPContrastiveSolver):
    ...
    def backup(self):
        ...
        copyfile('models/sasrecpp.py', self.data_dir / 'model.py')
        copyfile('solvers/sasrecpp.py', self.data_dir / 'solver.py')
